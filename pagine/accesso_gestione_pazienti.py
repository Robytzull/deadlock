...
layout = html.Div([
    ...
    create_breadcrumb_header("ACCESSO GESTIONE PATIENTI", "/accesso-gestione-pazienti"),
            ...
            dbc.Row([
                dbc.Col(
                    html.A(
                        dbc.Card([
                            dbc.CardBody(
                                html.H4("Add Minori", className="card-title", style={'textAlign': 'center'})
                            )
                        ], style={'backgroundColor': '#7bb372', 'color': 'white'}),  # Colore verde e testo bianco
                        href='/add-minori',  # Link alla pagina di gestione visite
                        style={
                            'textDecoration': 'none', 
                            'display': 'block', 
                            'height': '150px', 
                ...
                dbc.Col(
                    html.A(
                        dbc.Card([
                            dbc.CardBody(
                                html.H4("Add Adolescenti", className="card-title", style={'textAlign': 'center'})
                            )
                        ], style={'backgroundColor': '#7bb372', 'color': 'white'}),  # Colore verde e testo bianco
                        href='/add-adolescenti',  # Link alla pagina di gestione pazienti
                        style={
                            'textDecoration': 'none', 
                            'display': 'block', 
                            'height': '150px', 
                ...
                dbc.Col(
                    html.A(
                        dbc.Card([
                            dbc.CardBody(
                                html.H4("Add Adulti", className="card-title", style={'textAlign': 'center'})
                            )
                        ], style={'backgroundColor': '#7bb372', 'color': 'white'}),  # Colore verde e testo bianco
                        href='/add-adulti',  # Link alla pagina di gestione medici
                        style={
                            'textDecoration': 'none', 
                            'display': 'block', 
                            'height': '150px', 
