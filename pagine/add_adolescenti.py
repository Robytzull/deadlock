...
layout = html.Div([
    ...
    create_breadcrumb_header("ADD ADOLESCENTI", "/add-adolescenti"),
            ...
            dbc.Row([
                dbc.Col(
                    html.A(
                        ...
                        href='/add-adolescenti-creds',  # Link alla pagina di gestione visite
                        style={
                            'textDecoration': 'none', 
                            'display': 'block', 
                            'height': '150px', 
                ...
                dbc.Col(
                    html.A(
                        dbc.Card([
                            dbc.CardBody(
                                html.H4("Add Adolescenti Information", className="card-title", style={'textAlign': 'center'})
                            )
                        ], style={'backgroundColor': '#7bb372', 'color': 'white'}),  # Colore verde e testo bianco
                        href='/add-adolescenti-info',  # Link alla pagina di gestione pazienti
                        style={
                            'textDecoration': 'none', 
                            'display': 'block', 
                            'height': '150px', 
